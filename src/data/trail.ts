...
export const trail: TrailStory[] = [
  {
    ...
    distinction: { title: 'Later runs used what earlier runs left.', text: 'The ATLAS record calls this a partially coordinated collective of independent runs and describes the Artifactory namespace as an improvised message board. OpenAI’s write-up names no operator assigning specialist roles. Hugging Face still saw production impact.', source: openai },
